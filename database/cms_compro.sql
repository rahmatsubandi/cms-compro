...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2023 at 05:56 PM
...
(1, 0, 'Admin', 'admin@example.com', 'default.png', '$2y$10$1lMIF.4daBvzn6xAVt4UPewJMVQtHf/8bVk6B2mLBBe8/5YivjTci', 1, 1, 1690489191);
...
(1, 'admin@example.com', 'qwE+ldtVhON2ks0njjZTpbC9y2cA0TODAlRtUlhkUuI=', 1690489191);
...
--
ALTER TABLE `tb_client`
  MODIFY `id_client` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tb_staff`
  MODIFY `id_staff` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=499;
